<template>
  <form @submit.prevent = 'submitData'>
    <div class="form-control" :class = "{invalid: isInValid}">
      ...
      <input id="user-name" name="user-name" type="text" v-model.trim = "enteredName" @blur="validate" />
      <p v-if="isInValid">Please enter something</p>
    </div>
    <div class="form-control">
      <label for="age">Your Age (Years)</label>
      <input id="age" name="age" type="number" v-model = "enteredNumber" />
    </div>
    <div class="form-control">
    ...
    <div class="form-control">
       <div>
        ...
        <label for="agreement">Terms and Conditions : I agree</label>
      </div>
      <div class="form-control">
        <the-rating v-model="rating" ></the-rating>
      </div>
...
<script>
import TheRating from './rating.vue'
export default{
  components:{
    TheRating
  },
  ...
  methods:{
    submitData(){
      ...
      this.entererdNamme = ""
      console.log(`entered Number : ${this.enteredNumber}`);
      this.enteredNumber = "";
